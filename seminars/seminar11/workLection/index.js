...
productData.forEach(({ name, image, price, color, size, quantity }) => {
	...
	<div class="product__content">
			...
			<div class="product__desc">
				...
				<input class="input__quantity" type="number" min = "0" value="${quantity}">
				</div>
				</div>
				</div>
	</div>
...
const deleteButtons = document.querySelectorAll('.btn__delete');// Важно. Найти все кнопки удаления после их создания циклом .
